...
<div class="col-lg-3">
  <div class="list-group">
	  <a href="#" class="list-group-item active">By flight number</a>
	  <a href="#" class="list-group-item">By customer name</a>
	  <a href="#" class="list-group-item">Customers have seats</a>
  </div>
</div>
