...
<div class="col-lg-3">
   <div class="list-group">
 	  ...
 	  <a href="reservationHistory.jsp" class="list-group-item">All reservations</a>
   </div>
  </div>
 <div class='col-lg-9'>
<%
